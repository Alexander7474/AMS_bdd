...
public class ProductsTab {
    ...
    public static void loadProductsTab(JPanel contentPanel, JFrame frame) {
        ...
        addProductButton.setForeground(new Color(51, 51, 51));
        addProductButton.setBackground(new Color(255, 183, 77));
        cstProducts.gridy = 2;
        ...
        deleteProductButton.setForeground(new Color(51, 51, 51));
        deleteProductButton.setBackground(new Color(255, 183, 77));
        cstProducts.gridy = 3;
